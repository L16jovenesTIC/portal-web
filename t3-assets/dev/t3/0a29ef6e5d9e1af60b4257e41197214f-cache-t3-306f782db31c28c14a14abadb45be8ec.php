<?php die("Access Denied"); ?>#x#s:79491:"//
// Variables
// --------------------------------------------------
...
@font-size-base:          14px;
@font-size-large:         ceil(@font-size-base * 1.28); // ~18px
...
@font-size-h4:            ceil(@font-size-base * 1.14);
@font-size-h5:            @font-size-base;
...
@dropdown-fallback-border:       @white;
...
// Navbar links
@navbar-default-link-color:                #bebebe;
@navbar-default-link-hover-color:          #fff;
@navbar-default-link-hover-bg:             #222;
@navbar-default-link-active-color:         #fff;
@navbar-default-link-active-bg:            #222;
...
// Off-Canvas Header
@t3-off-canvas-header-background:     @gray-darker;
@t3-off-canvas-header-text-color:     #525661;
